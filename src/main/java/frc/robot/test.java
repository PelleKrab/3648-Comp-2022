...
//     // // Use limelight to and aim towards it
//     // if ((rightEconder + leftEncoder) / 2 / 10.75 * 18.5 >= autoDistance && timer.get() < 4) {
//     //   if (Lx > 1) {
//     //     r_leadMotor.set(autoTurnSpeed);
//     //     l_leadMotor.set(autoTurnSpeed);
//     //   } else if (Lx < 1) {
//     //     r_leadMotor.set(-autoTurnSpeed);
//     //     l_leadMotor.set(-autoTurnSpeed);
//     //   } else {
...
//     // // Set shooter speed based ont the limelight
//     // if (timer.get() > 4 && timer.get() < 8) {
//     //    shooter.set(autoShooterSpeed);
//     // }
...
//     //     // Turn right
//     //     r_leadMotor.set(0.6);
//     //     l_leadMotor.set(-0.6 + turnSpeed);

//     //   } else if (centerX < 280) {
//     //     // Turn left
//     //     r_leadMotor.set(0.6 - turnSpeed);
//     //     l_leadMotor.set(-0.6);
//     //   }
...
//     //Shoot Button
//     if (shooter_joystick.getRawButtonReleased(2) && !ir.get()) {
//       startT = System.currentTimeMillis();
//       rpmS = S_Encoder.getVelocity();
//       // intakeCuh = 0;
//     }

//     if (counter - startT <= 500) {
//       s = .5;
//     } else if (counter - startT > 500 && !ir.get()) {
//       s = 0;
//       startT = 0;
//     } else if (counter - startT > 500 && ir.get()) {
//       s = 0;
...
//     if (shooter_joystick.getRawAxis(2) != 0) {
//       shooterSpeed = shooter_joystick.getRawAxis(2);

//     } else if (shooter_joystick.getRawAxis(3) != 0) {

//       if (S_Encoder.getVelocity() - autoShooterSpeed > 2000) {
//         incval = .2;
//       } else if (S_Encoder.getVelocity() - autoShooterSpeed > 1000 && S_Encoder.getVelocity() - autoShooterSpeed < 2000) {
//         incval = .2;
//       } else {
//         incval = .00055;
//       }

//       if (rpmAdjustedSpeed > .7) {
//         rpmAdjustedSpeed = .7;
//       } else if (rpmAdjustedSpeed < .25) {
//         rpmAdjustedSpeed = .25;
//       }
//       if (S_Encoder.getVelocity() < autoShooterSpeed - 20) {
//         rpmAdjustedSpeed += incval;
//       } else if (S_Encoder.getVelocity() > autoShooterSpeed + 20) {
//         rpmAdjustedSpeed -= incval * 1.25;
//       }
//       //shooterSpeed = rpmAdjustedSpeed;
